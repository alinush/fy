...
//
// The bn254Group parameter should be the BN254 G1 group, matching the group
// used for the DKG polynomial and VSS commitments.
//
...
func DkgOutputToKeyShare(bn254Group group.Group, nodeID int, output *DkgOutput) (*frost.KeyShare, error) {
